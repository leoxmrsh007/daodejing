...
《道德经》多版本对照学习平台是一个基于 Flask 的 Web 应用程序，支持多版本古籍对照阅读、疑难字标注、TTS语音朗读、AI辅助学习等功能。

### 1.2 核心功能

- **多版本对照**：支持原文、多种注释、英文翻译并列展示
- **古籍版本**：马王堆帛书本、郭店楚简本
- **注释版本**：王弼注、河上公注、王夫之《老子衍》、憨山德清注
...
| 数据存储 | JSON 文件 (data/daodejing.json) |
...
│  │                   数据层 (Data)                   │  │
│  │  ┌──────────┐ ┌──────────┐ ┌──────────┐         │  │
│  │  │daodejing │ │ classics │ │commentator│         │  │
│  │  │.json     │ │.json     │ │s.json     │         │  │
│  │  └──────────┘ └──────────┘ └──────────┘         │  │
│  └──────────────────────────────────────────────────┘  │
└─────────────────────────────────────────────────────────┘
...
| `/api/{classic_id}/chapters` | 获取章节列表 |
| `/api/{classic_id}/chapter/{id}` | 获取单章数据 |
| `/api/daodejing/chapters` | 向后兼容 |
