...
class ConceptExtractor:
    ...
    def __init__(self) -> None:
        self.concept_chapters: defaultdict[Any, Set] = defaultdict(
            set
        )  # 概念出现的章节
        self.concept_cooccurrence: defaultdict[Any, Counter] = defaultdict(
            Counter
        )  # 概念共现
...
class CommentryAnalyzer:
    ...
    def __init__(self) -> None:
        self.commentary_views: defaultdict = defaultdict(dict)  # 存储各注释家观点
...
class KnowledgeGraphBuilder:
            ...
            for concept in concepts:
                if concept not in concept_map:
                    ...
                    concept_map[concept] = {
                        ...
                        "level": level,
                        "chapters": list(
                            self.concept_extractor.concept_chapters[concept]
                        ),
    ...
    def _infer_relation(self, c1: str, c2: str) -> str:
        ...
        return (
            known_relations.get((c1, c2)) or known_relations.get((c2, c1)) or "关联关系"
        )
...
def get_all_concepts() -> List[Dict]:
    ...
    for chapter in data["chapters"]:
        concept_extractor.extract_from_chapter(
            chapter["chapter"], chapter.get("original", "")
        )
