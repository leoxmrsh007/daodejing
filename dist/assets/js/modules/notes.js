...
const NotesManager = {
    ...
    getAllNotes() {
        try {
            ...
            console.error('[NotesManager] 读取笔记失败:', e);
            return {};
        }
    },
    ...
    saveNote() {
        ...
        try {
            ...
            console.error('[NotesManager] 保存笔记失败:', e);
    ...
    deleteNote() {
        ...
        try {
            ...
            console.error('[NotesManager] 删除笔记失败:', e);
    ...
    exportNotes() {
        ...
        this.showToast(`已导出 ${noteCount} 条笔记`, 'success');
    },
    ...
    importNotes(file) {
        ...
        reader.onload = (e) => {
            try {
                ...
                this.showToast(`已导入 ${importedCount} 条笔记`, 'success');
                this.updateButtonState();
            } catch (err) {
                console.error('[NotesManager] 导入笔记失败:', err);
...
if (typeof window !== 'undefined') {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (btn) {
            e.preventDefault();
            if (!NotesManager.currentChapter) {
                NotesManager.currentChapter = NotesManager.getCurrentChapter();
            }
            NotesManager.ensureModalExists();
